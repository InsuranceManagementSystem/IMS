...
const serverUrl = "http://localhost:8080/carinsurance";
function CarCard(props) {
  const navigate = useNavigate();
  var carForm = JSON.parse(window.localStorage.getItem("carForm"));
  var values = {
    "startDate":new Date(),
    "carRegNo": carForm.carRegNo,
    "carType": carForm.carType,
    "regDate": carForm.regDate,
    ...
    <div>
      <Card style={{ width: '18rem' }}>
        ...
        <ListGroup className="list-group-flush">
          <ListGroup.Item>IDV Cover: ₹ {props.idvCover}</ListGroup.Item>
